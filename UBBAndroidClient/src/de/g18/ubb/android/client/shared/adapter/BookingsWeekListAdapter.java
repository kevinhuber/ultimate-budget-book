...
import de.g18.ubb.android.client.shared.adapter.BookingsWeekListAdapter.BookingTag;
...
public final class BookingsWeekListAdapter extends AbstractAdapter<Booking, BookingTag> {
    ...
    public BookingsWeekListAdapter(Context aContext, List<Booking> aBooking) {
