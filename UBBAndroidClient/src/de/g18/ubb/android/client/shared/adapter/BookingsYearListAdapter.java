...
import de.g18.ubb.android.client.shared.adapter.BookingsYearListAdapter.BookingTag;
import de.g18.ubb.android.client.utils.UBBConstants;
import de.g18.ubb.common.domain.Booking;

public final class BookingsYearListAdapter extends AbstractAdapter<Booking, BookingTag> {

	public BookingsYearListAdapter(Context aContext) {
        this(aContext, new ArrayList<Booking>());
    }

    public BookingsYearListAdapter(Context aContext, List<Booking> aBooking) {
